...
setShowMessage(true);
  ...
  return (
    ...
    <div  className="flex justify-center items-center ">
      {isLoading ? (
        <article className="flex justify-center items-center mt-[200px]">
          ...
          {
showMessage && <p className="flex items-center justify-center m-10 text-2xl flex-col font-serif text-wrap flex-wrap">❌Please active or allow access to location❌</p>
          }
